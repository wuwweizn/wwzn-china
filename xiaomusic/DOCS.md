...
1. 在 HA 中加载nas中的音乐，设置-系统-存储-网络储存（添加网络存储-music-媒体-nas_ip【服务器】-Samba【协议】-music【远程共享】-nas用户名密码），在ha媒体-My media查看是否挂载成功
2. 在应用xiaomusic后台【默认主题-设置-高级配置-音乐目录】配置你挂载的文件，通常`/media/music`
3. 在 XiaoMusic 管理的播放器页面点击 **刷新图标**，查看是否加载成功
